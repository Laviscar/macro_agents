...
| **V1.7** | **叙事委员会圆桌**：驱动**逼近切换**时(邻近度 0.60/0.75/0.90 分级 + 加速度触发,为提前交易而设)标记待召开;**人工召开**可配置委员会(人格/专长/LLM/skill 库,规则化自动组阵 + 预设阵容),复用 V1.5 AuditPanel 多轮讨论,**主席综合机构 memo 级结论**(BLUF/方向/信心/时间窗/催化剂/证伪/仓位/分歧/证据)。**咨询不动图**:只打徽章、影响今日排序。人工门控召开 + 召开前显示预估调用次数控成本。设计见 `docs/superpowers/specs/2026-06-02-v1.7-narrative-committee-design.md` |
